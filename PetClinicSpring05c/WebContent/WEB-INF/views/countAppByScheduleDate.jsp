        ...
        <div class="col-12">
          <div class="card">
			...
			<th>Show</th>
                ...
                <tbody>
          <c:forEach var="at" items="${appointmentRegisterForm.countAppByScheduleDateForms}" varStatus="s">
		    	<tr>
				<td>${s.index+1}</td>
				<td>${at.scheduleId}</td>
				<td>${at.date}</td>
				<td>${at.count}</td>
				<td><a href="showAppointmentByDate?frmScheduleId=${at.scheduleId}&frmDate=${at.date}"class="btn btn-block btn-outline-primary btn-sm">Show</a></td>
				</tr>		
		        </c:forEach>
                </tbody>
