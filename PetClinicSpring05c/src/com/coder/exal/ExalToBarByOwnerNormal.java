...
public class ExalToBarByOwnerNormal {
	...
	public static void barColumnChart( ShowAppointmentForm showAppointmentForm,XSSFWorkbook wb) throws FileNotFoundException, IOException {
			String sheetName = "ShowOwnerByNormal";
			XSSFSheet sheet = wb.createSheet(sheetName);

		
			Row row = sheet.createRow((short) 0);
			List<ShortestJobFirstForm> firstForms1=showAppointmentForm.getNoShortestJobFirstForms();
			List<ShortestJobFirstForm> firstForms=PrjSubFunction.sortByIdSJF(firstForms1);
			System.out.println("firstForms"+firstForms.size());
			Cell cell=null;
            ...
            bottomAxis.setTitle("Owner Id  "+"WtTotal="+showAppointmentForm.getNoWatingAvg());
