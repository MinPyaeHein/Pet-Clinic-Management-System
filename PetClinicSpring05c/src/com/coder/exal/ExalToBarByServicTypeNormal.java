...
public class ExalToBarByServicTypeNormal{
	...
	public static void barColumnChart(List< ShowAppointmentForm> showAppointmentForms,XSSFWorkbook wb) throws FileNotFoundException, IOException {
			String sheetName = "Show Data By ServicType Normal";
			...
			cell.setCellValue(showAppointmentForm.getServicTypeName());
            }
            int wtTotal=0;
            ...
            bottomAxis.setTitle("Servic Type "+"WtTotal="+wtTotal);
            ...
            series1.setTitle("Servic Type", null);
            ...
            String filename = "D:\\dgl\\ExalToBarByServicType.xlsx";//"column-chart-top-seven-countries.xlsx";
